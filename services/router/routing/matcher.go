...
type RuleEngine struct {
	...
	providers       map[string]*model.Config // 供应商注册表
...
func NewRuleEngine(rules []Rule, providers map[string]*model.Config, defaultProvider string) *RuleEngine {
	// 复制并排序（不修改调用方的切片）。
...
func (e *RuleEngine) Match(_ context.Context, prompt string, model string) *model.Config {
