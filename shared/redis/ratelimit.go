...
//   - maxRate: 窗口内最大请求数
func NewRedisRateLimiter(client *goRedis.Client, key string, window time.Duration, maxRate int) *RedisRateLimiter {
...
func NewRedisTokenBucket(client *goRedis.Client, key string, capacity int, rate float64) *RedisTokenBucket {
...
func NewMultiDimensionRateLimiter(client *goRedis.Client) *MultiDimensionRateLimiter {
